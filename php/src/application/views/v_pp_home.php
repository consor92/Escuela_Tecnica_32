...
<style>
body {
background-image: url(<?= ASSETS_URL; ?>assets/img/400h.jpg);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <main class="m-5 text-white">
    <h1>Prácticas Profesionalizantes</h1>
    <p>Es hora de implementar tus destrezas.</p>
    
      <a href="<?= base_url(); ?>C_pp/registro" class="btn btn-lg btn-primary">Registrate</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-info text-white">
        <h5 class="modal-title" id="staticBackdropLabel">Ingreso de Usuarios</h5>
      ...
      <div class="modal-body">
                            <form class="form-horizontal" role="form" method="post">
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        <label for="inputEmail3" class="control-label"><b>Usuario</b></label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        <label for="inputPassword3" class="control-label"><b>Password</b></label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                  ...
                                  <button type="submit" class="active btn btn-success">Ingresar</button>
                                </div>
