...
<div class="section"><div class="container"><div class="row"><div class="col-md-12"><div class="page-header"><h1 class="text-primary">Ingreso de tareas<br>&nbsp;<small>Realizadas el día de hoy</small></h1></div></div></div></div></div>
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" method="post" action="<?= base_url(); ?>c_perfil/modificar_bitacora_hoy">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="tarea" name="tarea" placeholder="Ingrese el titulo de la tarea" value="<?= $fila->titulo; ?>">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  ...
                  <textarea class="form-control" rows="10" id="descripcion" name="descripcion"><?= $fila->descripcion; ?></textarea>
                </div>
              </div>
              <div class="form-group">
