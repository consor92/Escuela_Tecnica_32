...
import { Clock, BookOpen, Building, Send } from 'lucide-react';
      ...
      <div className="space-y-4">
        <div>
          <label className="flex items-center gap-2 text-sm font-semibold text-slate-700 mb-2">
            <Building size={18} className="text-slate-400" /> Empresa / Institución
          </label>
          <select 
            value={companyId} 
        ...
        <div>
          <label className="flex items-center gap-2 text-sm font-semibold text-slate-700 mb-2">
            <Clock size={18} className="text-slate-400" /> Horas Efectivas
          </label>
          <input 
            type="number" 
            step="0.5"
